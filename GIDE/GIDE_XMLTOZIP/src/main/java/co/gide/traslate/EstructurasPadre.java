...
public class EstructurasPadre {
	...
	public EstructurasPadre(ArchivoElectronicoTipo objArchElec, Empresa datosEmpresa) {
	...
	public InvoiceType getFactura() throws ParseException {
		...
		Extensiones objArmarExtensiones = new Extensiones(objArchElec, datosEmpresa);
		...
		if (!objArchElec.getNota().isEmpty() || objArchElec.getNota() != null) {
