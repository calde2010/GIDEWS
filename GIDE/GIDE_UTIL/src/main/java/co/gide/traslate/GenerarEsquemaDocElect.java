...
public class GenerarEsquemaDocElect implements Serializable {
	...
	//SE LE APLICO LA PROPIEDAD PUBLIC IDIAZ
	public GenerarEsquemaDocElect(InvoiceType objInvoiceType, String nomDocu, String ruta, String tipoDocu ) {
	...
	GenerarEsquemaDocElect(CreditNoteType objCreditNote, String nomDocu, String ruta, String tipoDocu) {
	...
	GenerarEsquemaDocElect(DebitNoteType objDebitNote, String nomDocu, String ruta, String tipoDocu) {
		this.tipoDocumento=tipoDocu;
		this.nombreDocumento = nomDocu;
		this.ruta = ruta;
	...
	public  Boolean crearDocumentoElectronico() throws JAXBException{
		...
		if (tipoDocumento.equals("1")) {// Factura electronica
			try {
		...
		} else if (tipoDocumento.equals("2")) {// Nota Debito
			try {
		...
		} else if (tipoDocumento.equals("3")) {// Nota Credito
			try {
